...
const createScrollProgress = () => {
    ...
    progressBar.style.background = 'linear-gradient(90deg, #00d2ff, #7b2cbf)';
...
window.addEventListener('scroll', () => {
    ...
    if (hero) {
        const position = -scrolled * 0.5;
        hero.style.backgroundPositionY = `${position}px`;
    }
});
...
console.log('Visual Studio - Estúdio Digital carregado com sucesso! 🚀');
